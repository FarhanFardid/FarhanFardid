...
#### CSE Graduates || Full Stack web Developer || MERN Stack Developer || Front End Developer
...
With a solid foundation in HTML, CSS, and JavaScript, I excel in developing responsive and visually appealing web interfaces. I have hands-on experience in React, Node.js, MongoDB and Express.js, allowing me to build robust and scalable applications. Additionally, I possess proficiency in CSS frameworks such as Tailwind CSS, Bootstrap, and libraries like Daisy UI and Material UI, enhancing my ability to create stunning designs.
...
![GitHub Activity Graph](https://activity-graph.herokuapp.com/graph?username=FarhanFardid)  

![GitHub metrics](https://metrics.lecoq.io/FarhanFardid)  

![GitHub streak stats](https://streak-stats.demolab.com/?user=FarhanFardid)  

![Profile views](https://gpvc.arturio.dev/FarhanFardid)  
